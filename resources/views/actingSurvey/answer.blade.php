    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class=" add_top_30">
                ...
                <textarea name="additional_message" class="form-control required" style="height:150px;" placeholder="{{$question->detail}}" onkeyup="getVals(this, '{{$answer->name}}');"></textarea>
            </div>
        </div>
    </div>
</div>
...
<div class="budget_slider">
    <input type="range" name="timeframe" min="3" max="168" step="1" value="0" data-orientation="horizontal" onchange="getVals(this, 'timeframe');">
    <span>hours</span>
</div>
...
<div class="form-group add_top_30">
    <label>Additional information</label>
    <textarea name="additional_message" class="form-control required" style="height:150px;" placeholder="Type here additional info..." onkeyup="getVals(this, '{{$answer->name}}');"></textarea>
</div>
<div class="form-group add_top_30">
